...
This file records meaningful changes to the Year Zero Education project.

The project uses semantic release language for public versions where possible, but early repository work may use foundation-stage labels.
...
Create the complete repository foundation required to begin Stage 1.

### Completion criteria

- Project orientation is clear.
- Agent operating sequence is clear.
- Stage guides are complete.
- Research method is consolidated.
...
## Version 0.1 – Curriculum Hypothesis

Planned first public curriculum release after Stage 11.
...
- Traceability map.
- Public FAQ.
- Contribution and feedback pathway.
