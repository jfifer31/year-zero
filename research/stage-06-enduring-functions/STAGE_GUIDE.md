...
Stage 6 converts human invariants into enduring human functions. A function is not a school subject or skill label. It is something humans must still perform or embody in order to live well, participate responsibly and remain meaningfully agentic across plausible futures.
...
**Depends on:** Stage 5 pass-forward output.

**Feeds into:** Stage 7 Capability Derivation.
...
1. What functions follow from the human invariants?
2. What must humans still do even when AI systems are powerful?
3. Which functions are universal, which are context-dependent, and which are future-amplified?
4. What happens if a function is not developed or protected?
5. Which functions are individual, relational, civic, creative, practical or moral?
6. How should functions be grouped for capability derivation?
...
- capability naming as final curriculum language;
- lesson design;
- assessment design;
- subject allocation;
- future job lists;
...
- function derivation from invariants;
- dependency mapping;
- failure-mode analysis;
- criticality ranking;
- individual/relational/civic classification;
- downstream capability preparation;
...
- Stage 4 life pressures;
- human sciences and social theory where relevant;
- implementation constraints as contextual evidence;
...
- Enduring Human Function Map;
- Function Criticality Matrix;
- Function Failure Modes;
- Function-to-Invariant Traceability;
- Stage 6 Pass-Forward Memo;
...
- Are these functions just renamed 21st-century skills?
- Do they follow from invariants or appear from preference?
- Are some functions too abstract to support capability derivation?
- Are civic, moral or relational functions underweighted?
- Are functions being shaped by current school categories?
...
- authorised enduring functions;
- function groupings;
- criticality and risk notes;
- links to human invariants;
- function descriptions suitable for capability derivation;
...
```text
You are running Stage 6 – Enduring Human Functions of the Year Zero Education research programme.
